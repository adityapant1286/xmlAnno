...
public class FilterBuilder implements Predicate<String> {
    ...
    public FilterBuilder(final Iterable<Predicate<String>> filters) { chain = Lists.newArrayList(filters); }
    ...
    public FilterBuilder includePackage(final String... prefixes) {
        Stream.of(prefixes).forEach(p -> add(new Include(prefix(p))));
        return this;
    }
    ...
    public boolean apply(String regex) {
        ...
        boolean accept = isNull(chain) || chain.isEmpty() || chain.get(0) instanceof Exclude;
    ...
    public static FilterBuilder parse(String includeExcludeString) {
        ...
        if (hasText(includeExcludeString)) {
